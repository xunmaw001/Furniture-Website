    ...
    >
      <el-row>
        ...
        <el-form-item class="select" v-if="type!='info'"  label="家具类型" prop="jiajuleixing">
          <el-select v-model="ruleForm.jiajuleixing" placeholder="请选择家具类型">
            <el-option
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tupian" label="图片" prop="tupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tupian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="家具风格" prop="jiajufengge">
          <el-input v-model="ruleForm.jiajufengge" 
              placeholder="家具风格" clearable  :readonly="ro.jiajufengge"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="家具风格" prop="jiajufengge">
              <el-input v-model="ruleForm.jiajufengge" 
                placeholder="家具风格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="规格" prop="guige">
          <el-select v-model="ruleForm.guige" placeholder="请选择规格">
            <el-option
                v-for="(item,index) in guigeOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.jiajuxiangqing = this.ruleForm.jiajuxiangqing.replace(reg,'../../../springboot4f4p4/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
