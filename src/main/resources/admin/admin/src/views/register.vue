  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(254, 190, 0, 1);fontSize:28px;">家具网站注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="联系人" class="input" v-if="tableName=='shangjia'">
			  <el-input v-model="ruleForm.lianxiren" autocomplete="off" placeholder="联系人" type="text" />
																					...
																					<!-- <div v-if="tableName=='shangjia'" class="input-group">
			   <div class="label">经营内容</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jingyingneirong" class="input" type="text" placeholder="经营内容">
			   </div>
			 </div> -->
			<el-form-item label="经营内容" class="input" v-if="tableName=='shangjia'">
			  <el-input v-model="ruleForm.jingyingneirong" autocomplete="off" placeholder="经营内容" type="text" />
			</el-form-item>
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20201217/33c75d65836a4b6ebde1763bb3d6b6f3.jpg");
		height: 100vh;
